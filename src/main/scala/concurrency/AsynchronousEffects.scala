...
/**
 * This section is difficult and needs constant revise
 */
object AsynchronousEffects extends ZIOAppDefault {

  // CALLBACK-based is Asynchronous
  // asynchronous
  object LoginService {
  ...
  // lift the above login function with ZIO
  def loginAsZIO(id: String, pw: String): ZIO[Any, LoginService.AuthError, LoginService.UserProfile] =
  // 注意：如果不调cb=>, ZIO.async will be semantically blocked forever!
